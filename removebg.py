...
# Directory paths
input_dir = 'dataset/training/normal/proses'     # Ganti dengan direktori gambar yang ingin dihapus background-nya
output_dir = 'dataset/training/normal/proses/removebg'    # Ganti dengan direktori tempat menyimpan hasil gambar
